    ...
    sections: [
        {
            ...
            text: {
                ...
                english: "Shri Sodevpir Pooja app is designed for devotees. The main purpose of this app is to assist in devotion and spiritual practice."
            }
        },
        {
            subtitle: {
                gujarati: "માહિતી સંગ્રહ",
                hindi: "सूचना संग्रह",
        ...
        },
        {
            ...
            text: {
                gujarati: "જો તમારી પાસે કોઈ પ્રશ્નો હોય, તો તમે અમારો સંપર્ક કરી શકો છો.",
                hindi: "यदि आपके पास कोई प्रश्न है, तो आप हमसे संपर्क कर सकते हैं।",
                english: "If you have any questions, you can contact us."
            }
        }
    ]
};
